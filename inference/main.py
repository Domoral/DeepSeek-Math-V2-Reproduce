...
parser.add_argument("--proof_gen_num_processes", type=int, default=4)
...
parser.add_argument("--n_best_proofs_to_sample", type=int, default=4, help="the number of best proofs to consider for refinements")
parser.add_argument("--n_proofs_to_refine", type=int, default=1, help="the number of proofs used as the input for a refinement")
parser.add_argument("--n_agg_trials", type=int, default=4, help="the number of different combinations of proofs used for refinements")
parser.add_argument("--n_parallel_proof_gen", type=int, default=4)
